								...
								<div class="col fill_height">
									<div class="home_container d-flex flex-column align-items-center justify-content-start">
										<div class="home_content">
											<div class="home_title">ПРЕДЛОЖЕНИЕ МЕСЯЦА</div>
											<div class="home_subtitle">ЗАБИРАЙ ПРЯМО СЕЙЧАС!</div>
											<div class="home_items">
												<div class="row">
													<div class="col-sm-3 offset-lg-1">
														<div class="home_item_side" style="overflow: hidden; width: 600px;  height: 200px;"><img src="'.$Car['CarImg1'].'"></div>
													</div>
													<div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
														<div class="product home_item_large">
															<div class="product_tag d-flex flex-column align-items-center justify-content-center">
																<div>
																	<div>from</div>
																	<div>'.$Car['CarPrice'].'€</span></div>
																</div>
															</div>
															<div class="product_image"><img src="'.$Car['CarImg2'].'"></div>
															<div class="product_content">
																<div class="product_info d-flex flex-row align-items-start justify-content-start">
																	...
																	<div class="ml-auto text-right">
																		...
																		<div class="product_price text-right">'.$Car['CarPrice'].'€</span></div>
																	</div>
																</div>
													...
													<div class="col-sm-3">
														<div class="home_item_side"><img src="'.$Car['CarImg3'].'"></div>
													</div>
												</div>
											</div>
										</div>
